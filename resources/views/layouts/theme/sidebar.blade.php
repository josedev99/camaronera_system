        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                <ul class="menu-categories">
                    ...
                    <a href="{{url('dash')}}" data-active="true" class="menu-toggle">
                            ...
                            <div class="base-menu">
                                <div class="base-icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M11 2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12h.5a.5.5 0 0 1 0 1H.5a.5.5 0 0 1 0-1H1v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h1V7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7h1V2zm1 12h2V2h-2v12zm-3 0V7H7v7h2zm-5 0v-3H2v3h2z"/></svg>
                                </div>
                                <span>Dashboard</span>
                            </div>
                        </a>
                    ...
                    <li>
                    <a href="{{url('sales')}}" data-active="true" class="menu-toggle">
                    ...
                    <li>
                    <a href="{{url('purchases')}}" data-active="true" class="menu-toggle">
                    ...
                    <li>
                    <a href="{{url('denominations')}}" data-active="true" class="menu-toggle">
                        
                            <div class="base-menu">
                                <div class="base-icons">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                                </div>
                                <span>Denominacione</span>
                            </div>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{url('providers')}}" data-active="true" class="menu-toggle">
                        ...
                        <li>
                            <a href="{{url('customers')}}" data-active="true" class="menu-toggle">
                    ...
                    <a href="{{url('cashout')}}" data-active="true" class="menu-toggle">
