                                        ...
                                        <table class="table table-bordered table-hover mb-4">
                                            ...
                                            @foreach($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @can('user_edit')
                                                        <a href="javascript:void(0)" wire:click="Edit({{$user->id}})" class="btn btn-dark mtmobile" title="Editar"><i class="fas fa-edit mt-1"></i></a>
                                                        @endcan

                                                        @can('user_destroy')
                                                        <a href="javascript:void(0)" onclick="Confirm('{{$user->id}}')" class="btn btn-dark" title="Eliminar"><i class="fas fa-trash mt-1"></i></a>
                                                        @endcan
